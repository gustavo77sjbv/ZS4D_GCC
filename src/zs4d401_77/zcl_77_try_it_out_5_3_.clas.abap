CLASS zcl_77_try_it_out_5_3_ DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_77_try_it_out_5_3_ IMPLEMENTATION.
...
*Add 50 new connection numbers and 2000 days of flights for each
    ...
    INSERT z401_77_flights FROM TABLE @insert_tab.
    out->write( |Generated { sy-dbcnt } rows in table z401_77_flights| ).
