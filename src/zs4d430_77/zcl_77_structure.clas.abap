CLASS zcl_77_structure DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
...
*            INCLUDE TYPE Z77S_NAME    AS name.
*            INCLUDE TYPE Z77S_ADDRESS AS address.
*    TYPES END OF st_person_inc.
ENDCLASS.



CLASS ZCL_77_STRUCTURE IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    DATA address TYPE z77s_address.
...
*    DATA person2 TYPE st_person_inc.
    DATA person2 TYPE z77s_person_inc.
