CLASS zcl_77_table_type DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    " ---------------------------------------------------------------------
    TYPES tt_addresses TYPE SORTED TABLE OF z77s_address
...
CLASS ZCL_77_TABLE_TYPE IMPLEMENTATION.
...
*    DATA addresses TYPE tt_addresses.
    DATA addresses TYPE z77t_addresses.
...
*    DATA person TYPE st_person_deep.
    DATA person TYPE z77s_person_deep.
...
*    DATA persons TYPE tt_persons.
    DATA persons TYPE Z77T_PERSONS.
