...
define view entity Z77_R_EMPLOYEE
  as select from z77_employ as Employee
  association [1..1] to Z77_R_DEPARTMENT as _Department on $projection.DepartmentId = _Department.Id
{
