CLASS zcl_gu77_check_and_fill_v3 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_GU77_CHECK_AND_FILL_V3 IMPLEMENTATION.
...
*
    CONSTANTS c_employ_table  TYPE tabname VALUE 'ZGU77_EMPLOY'.
    CONSTANTS c_depment_table TYPE tabname VALUE 'ZGU77_DEPMENT'.
