CLASS zcl_gu77_structure DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
...
*            name    TYPE ZGU77S_NAME,
*            address TYPE ZGU77S_ADDRESS,
*           END OF st_person.
*
...
*            INCLUDE TYPE ZGU77S_NAME    AS name.
*            INCLUDE TYPE ZGU77S_ADDRESS AS address.
*    TYPES END OF st_person_inc.
ENDCLASS.



CLASS ZCL_GU77_STRUCTURE IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    DATA address TYPE zgu77s_address.
...
*    DATA person TYPE st_person.
    DATA person TYPE zgu77s_person.
...
*    DATA person2 TYPE st_person_inc.
    DATA person2 TYPE zgu77s_person_inc.
