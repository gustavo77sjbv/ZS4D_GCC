...
CLASS lcl_flights DEFINITION.
  ...
  PRIVATE SECTION.
    ...
    DATA standard_table TYPE STANDARD TABLE OF zlrn_passflight
                        WITH NON-UNIQUE KEY carrier_id connection_id flight_date.
    DATA sorted_table   TYPE SORTED TABLE OF zlrn_passflight
                        WITH NON-UNIQUE KEY carrier_id connection_id flight_date.
    DATA hashed_table   TYPE HASHED TABLE OF zlrn_passflight
