...
CLASS lcl_generator_carrier DEFINITION INHERITING FROM lcl_generator.
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS c_tabname TYPE tabname VALUE 'ZLRN_CARRIER'.
    ...
    DATA carriers TYPE TABLE OF zlrn_carrier READ-ONLY.
...
CLASS lcl_generator_connection DEFINITION INHERITING FROM lcl_generator.
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS c_tabname TYPE tabname VALUE 'ZLRN_CONNECTION'.
    ...
    DATA connections TYPE TABLE OF zlrn_connection READ-ONLY.
...
CLASS lcl_generator_airport DEFINITION INHERITING FROM lcl_generator.
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS c_tabname TYPE tabname VALUE 'ZLRN_AIRPORT'.
    ...
    DATA airports TYPE TABLE OF zlrn_airport READ-ONLY.
...
CLASS lcl_generator_passflight DEFINITION INHERITING FROM lcl_generator.
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS c_tabname TYPE tabname VALUE 'ZLRN_PASSFLIGHT'.
    ...
    DATA flights TYPE TABLE OF zlrn_passflight READ-ONLY.
...
CLASS lcl_generator_cargoflight DEFINITION INHERITING FROM lcl_generator.
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS c_tabname TYPE tabname VALUE 'ZLRN_CARGOFLIGHT'.
    ...
    DATA flights TYPE TABLE OF zlrn_cargoflight READ-ONLY.
